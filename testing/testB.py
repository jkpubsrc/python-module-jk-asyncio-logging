...
async def main():
	...
	flog = AsyncioFilterLogger.create(
		ConsoleLogger.create(logMsgFormatter=COLOR_LOG_MESSAGE_FORMATTER),
		minLogLevel=EnumLogLevel.WARNING
		)
	...
	mlog = AsyncioMulticastLogger.create(clog, clog)
	...
	nmlog = AsyncioNamedMulticastLogger.create()
